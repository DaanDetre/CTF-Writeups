...
def check_key(key, username_trial):
    ...
    print(
        f"{hashlib.sha256(username_trial).hexdigest()[4]}{hashlib.sha256(username_trial).hexdigest()[5]}"
        f"{hashlib.sha256(username_trial).hexdigest()[3]}{hashlib.sha256(username_trial).hexdigest()[6]}"
        f"{hashlib.sha256(username_trial).hexdigest()[2]}{hashlib.sha256(username_trial).hexdigest()[7]}"
        f"{hashlib.sha256(username_trial).hexdigest()[1]}{hashlib.sha256(username_trial).hexdigest()[8]}")
